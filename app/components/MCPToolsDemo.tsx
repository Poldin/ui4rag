...
export default function MCPToolsDemo() {
  ...
  return (
    <div className="relative w-full">
      {/* Main Demo Container */}
      <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 p-8 shadow-xl">
        {/* Header */}
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {toolCalls.map((tool, index) => {
            ...
            return (
              <div
                key={tool.name}
                className={`relative border-2 rounded-xl p-6 transition-colors duration-500 min-h-[400px] flex flex-col ${
                  isActive
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                      ...
                      <ToolIconComponent className={`w-6 h-6 ${isActive ? tool.color : 'text-gray-500'}`} />
                    </div>
                    <div>
                      <code className="text-sm font-bold text-gray-900 font-mono">{tool.name}</code>
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          <div className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-500 ${
            ...
            <span className="text-sm font-semibold">Step 1: RAG Search</span>
          </div>
          ...
          <div className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-500 ${
            ...
            <span className="text-sm font-semibold">Step 2: Keyword Search</span>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-6 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-bold text-lg mb-2">Access via MCP Protocol</h4>
              <p className="text-gray-300 text-sm mb-4">
                Connect your AI agents to your RAG knowledge base through the Model Context Protocol. 
                Use <code className="bg-white/20 px-2 py-0.5 rounded font-mono text-xs">search_docs_rag</code> for semantic search 
                and <code className="bg-white/20 px-2 py-0.5 rounded font-mono text-xs">search_docs_keyword</code> for precise keyword matching.
              </p>
