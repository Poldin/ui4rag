  ...
  return (
    <div className="relative">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredFeatures.map((feature) => {
          ...
          return (
            <div
              key={feature.id}
              className={`group relative bg-white border rounded-xl p-5 transition-all hover:shadow-lg ${
                feature.status === "live" 
            ...
            >
              ...
              <div className="absolute top-4 right-4">
                <div className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium ${status.bgColor} ${status.textColor} border ${status.borderColor}`}>
              ...
              {/* Content */}
              <h3 className="text-sm font-semibold text-gray-900 mb-1.5 pr-24">
                {feature.title}
              </h3>
      ...
      <div className="mt-12 text-center">
        <div className="inline-block bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-xl p-6 max-w-2xl">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-lg font-semibold text-sm transition-all shadow-md hover:shadow-lg"
          >
